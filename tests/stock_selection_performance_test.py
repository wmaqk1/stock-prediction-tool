...
def performance_test(login_data, intervals=1, output_file='selection_results.txt'):
    '''
    Verify the accuracy of stock filtration and selection of most profitable ones
    made by the stock_choice module and deciding_on_stock_quantity.
    '''
    # Import data history
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        for run in range(intervals):
            ...
            try:
                ...
                result_df, unused_credit = stock_partition_in_portfolio(result_df, login_data)
                ...
                f # Calculate prediction accuracy and profits
                for res in program_results:
                    actual_diff = res['actual_price'] - res['current_price']
                    predicted_diff = res['predicted_price'] - res['current_price']
                    ...
                    predicted_profit += res['quantity'] * predicted_diff * res['exchange_rate']
                    actual_profit += res['quantity'] * actual_diff * res['exchange_rate']
